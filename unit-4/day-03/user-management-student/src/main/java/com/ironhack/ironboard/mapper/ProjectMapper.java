...
public class ProjectMapper {
    ...
    // Safe here because entities are loaded via findById/findAll, not lazy associations.
    // Chosen among several valid alternatives for readability at this course level.
