...
//   }
//
// PATTERN: A typed ErrorResponse DTO is better than a Map because:
//   - Compile-time safety: you can't misspell a field name
//   - IDE auto-complete: developers see the available fields
//   - Documentation: the class itself documents the error format
//   - Jackson serializes it consistently
//
// TIP: The timestamp is set in the constructor (LocalDateTime.now()),
// so every error response automatically includes when the error
// occurred. This helps with debugging.
//
