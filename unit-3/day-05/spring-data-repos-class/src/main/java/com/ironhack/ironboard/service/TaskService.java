...
// =============================================
// CHANGED from Step 04: HashMap → TaskRepository.
//
// Same transformation as ProjectService:
//   HashMap          → TaskRepository
//   for-loop filter  → derived query method (findByProjectId)
//   null check       → Optional.orElseThrow()
//   put()            → save()
//   remove()         → deleteById()
//   nextId++         → @GeneratedValue
//
// =============================================
@Service
