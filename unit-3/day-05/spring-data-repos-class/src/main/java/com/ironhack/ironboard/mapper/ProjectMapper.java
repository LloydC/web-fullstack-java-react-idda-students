...
//
// TIP: toModel() is overloaded -- same method name, different
// parameter types. Java uses the parameter type to decide which
// version to call. This is called method overloading.
// =============================================
public class ProjectMapper {
    ...
    //
    // WHY: This keeps the controller clean. Instead of:
    //   projectService.create(request.getName(), request.getDescription());
    // The controller does:
    ...
    //
    // TIP: For PATCH, some fields may be null (meaning "don't change").
    // The mapper copies them as-is. The service decides what to do
    // with null values (partialUpdate skips them, fullUpdate overwrites).
    // =============================================
    ...
    //
    // NOTE: createdAt is passed as LocalDateTime directly.
    // Jackson serializes it to ISO 8601 format automatically
    // (e.g., "2026-02-07T10:00:00").
    // =============================================
    ...
    //
    // TIP: Compare toResponse() vs toSummary():
    //   toResponse():      returns id, name, description, createdAt (full detail)
    //   toSummary():  returns id, name (lightweight)
    // The controller chooses which one to call based on the endpoint.
    // =============================================
