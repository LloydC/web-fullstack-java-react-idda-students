...
// =============================================
// TASK RESPONSE DTO — Day 8: DTOs & Mappers
// =============================================
...
//
// PATTERN: Response DTOs are IMMUTABLE (final fields, all-args
...
public class TaskResponse {
    ...
    // WHY String and not TaskStatus: See class header comment above
