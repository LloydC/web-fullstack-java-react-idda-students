...
public class Task {
    ...
    // @Enumerated(STRING) stores "TODO", "IN_PROGRESS", "DONE" as text (safer for reorder/insert).
    // ORDINAL stores 0, 1, 2 (fragile: reorder/insert changes meanings).
    ...
    // name="project_id" maps camelCase to snake_case. nullable=false -- every task must belong to a project.
